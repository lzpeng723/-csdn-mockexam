...
import net.csdn.ac.tasking.springboot.repository.BaseRepository;
import net.csdn.ac.tasking.springboot.response.QueryResult;
import net.csdn.ac.tasking.springboot.util.BeanUtils;
...
public abstract class BaseService<Entity extends BaseEntity> {
     ...
     * @return
     */
    public List<Entity> findAllByIdNotIn(Iterable<Long> ids) {
